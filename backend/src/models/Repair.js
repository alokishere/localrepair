...
const repairSchema = new mongoose.Schema(
  {
    ...
    problemDescription: { type: String, required: true, trim: true, minlength: 5, maxlength: 2000 },
    ...
    status: { type: String, enum: REPAIR_STATUSES, required: true, default: 'SEARCHING' },
